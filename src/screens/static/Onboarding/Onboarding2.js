      ...
      <View
        ...
        <View
          ...
          <Text
            ...
            Professionals offering the wellness services you deserve
          </Text>
          <Text
            style={{
              fontSize: 14,
          ...
          <View style={{height:10,width:50,alignSelf:"center",flexDirection:"row",alignItems:"center",justifyContent:"space-between",marginTop:10}}>
            <View style={{height:10,width:10,borderRadius:6,backgroundColor:Theme.colors.primaryColor}}></View>
            <View style={{height:10,width:10,borderRadius:6,backgroundColor:Theme.colors.primaryColor}}></View>
            <View style={{height:10,width:10,borderRadius:6,backgroundColor:"#9D9D9D"}}></View>
          </View>
          <View style={{width: '90%', alignSelf: 'center', marginTop: 30}}>
            <Button title={'Continue'} onPress={()=> navigation.navigate('onboarding3')} />
